/**
 * Comprehensive Country Dial Codes List with ISO codes, Flags, and Dial Prefixes
 */
...
export const COUNTRY_DIAL_CODES: CountryDialCode[] = [
  // ── Popular / Primary Destinations ──
  { code: "BD", name: "Bangladesh", dialCode: "880", flag: "🇧🇩", popular: true },
  { code: "SA", name: "Saudi Arabia", dialCode: "966", flag: "🇸🇦", popular: true },
  { code: "AE", name: "United Arab Emirates", dialCode: "971", flag: "🇦🇪", popular: true },
  { code: "QA", name: "Qatar", dialCode: "974", flag: "🇶🇦", popular: true },
  { code: "KW", name: "Kuwait", dialCode: "965", flag: "🇰🇼", popular: true },
  { code: "OM", name: "Oman", dialCode: "968", flag: "🇴🇲", popular: true },
  { code: "BH", name: "Bahrain", dialCode: "973", flag: "🇧🇭", popular: true },
  { code: "MY", name: "Malaysia", dialCode: "60", flag: "🇲🇾", popular: true },
  { code: "SG", name: "Singapore", dialCode: "65", flag: "🇸🇬", popular: true },
  { code: "IN", name: "India", dialCode: "91", flag: "🇮🇳", popular: true },
  { code: "PK", name: "Pakistan", dialCode: "92", flag: "🇵🇰", popular: true },
  ...
  { code: "TR", name: "Turkey", dialCode: "90", flag: "🇹🇷", popular: true },
  { code: "TH", name: "Thailand", dialCode: "66", flag: "🇹🇭", popular: true },
  { code: "ID", name: "Indonesia", dialCode: "62", flag: "🇮🇩", popular: true },
  { code: "EG", name: "Egypt", dialCode: "20", flag: "🇪🇬", popular: true },
  { code: "CN", name: "China", dialCode: "86", flag: "🇨🇳", popular: true },
  { code: "JP", name: "Japan", dialCode: "81", flag: "🇯🇵", popular: true },
  { code: "KR", name: "South Korea", dialCode: "82", flag: "🇰🇷", popular: true },
  { code: "AU", name: "Australia", dialCode: "61", flag: "🇦🇺", popular: true },
  { code: "IT", name: "Italy", dialCode: "39", flag: "🇮🇹", popular: true },
