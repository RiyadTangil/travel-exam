...
export const JWT_SECRET = process.env.JWT_SECRET || "default_jwt_secret_change_me_in_prod"
export const NEXTAUTH_SECRET = process.env.NEXTAUTH_SECRET || "your_secret_key"
