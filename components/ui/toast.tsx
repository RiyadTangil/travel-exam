...
>(({ className, ...props }, ref) => {
  // If children is an object, it might crash React. Ensure it's renderable.
  const children = props.children;
  const renderableChildren = typeof children === 'object' && children !== null && !React.isValidElement(children)
